...
void main()
{
    ...
    //v_tecture = vec2(a_texture.s, 1 - a_texture.t); // Flips the texture vertically
}
"""
...
# Vertices and color of the cube
...
cube_indices = [0,  1,  2,  2,  3,  0, # Each row specifies a face of the cube
                4,  5,  6,  6,  7,  4,
                8,  9, 10, 10, 11,  8,
                12, 13, 14, 14, 15, 12,
                16, 17, 18, 18, 19, 16,
...
triangle_vertices = [-0.5,-0.5, 0.0, 1.0, 0.0, 0.0,
...
cube_texture = load_texture("Previous practice/textures/tank_hiori.png", textures[0])
quad_texture = load_texture("Previous practice/textures/patrick.jpg", textures[1])
